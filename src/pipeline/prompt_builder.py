...
def build_few_shot_str(df, config: dict, n_per_class: int | None = None, seed: int = 42) -> str:
...
def build_prompts(df, config: dict, summary_stats_str: str, few_shot_str: str) -> list[dict]:
    """
